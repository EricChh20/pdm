package com.disarm.surakshit.pdm.EricPsync;
...
public class Controller {
    ...
    com.disarm.surakshit.pdm.EricPsync.Discoverer discoverer;
    FileManager fileManager;
    com.disarm.surakshit.pdm.EricPsync.FileTransporter fileTransporter;
    int syncInterval;
    ...
    Logger logger;
    com.disarm.surakshit.pdm.EricPsync.MapDataProcessor mapDataProcessor;
    com.disarm.surakshit.pdm.EricPsync.FilePriorityComparator filePriorityComparator;
    ...
    public Controller(com.disarm.surakshit.pdm.EricPsync.Discoverer discoverer, FileManager fileManager, com.disarm.surakshit.pdm.EricPsync.FileTransporter fileTransporter, int syncInterval,
        ...
        filePriorityComparator = new com.disarm.surakshit.pdm.EricPsync.FilePriorityComparator(fileManager, logger, priorityMethod);
        this.priorityMethod = priorityMethod;
        try {
            this.mapDataProcessor = new com.disarm.surakshit.pdm.EricPsync.MapDataProcessor(fileManager.FILES_PATH, fileManager.MAP_DIR_PATH);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    void manageOngoingDownloads(){
        for(Thread t : fileTransporter.ongoingDownloadThreads.keySet()){
            com.disarm.surakshit.pdm.EricPsync.FileTransporter.ResumeDownloadThread downloadRunnable = fileTransporter.ongoingDownloadThreads.get(t);
